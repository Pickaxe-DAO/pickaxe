    ...
    return (
      <>   
        ...
        {!this.isWalletConnected() || !this.isSoldOut() ?
          ...
          <svg className="text-black hover:fill-current hover:text-neutral-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 385.04 314.05"><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"></g></g>       
